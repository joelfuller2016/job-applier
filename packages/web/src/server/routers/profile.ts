 ...
 *
 * @param ctx - The tRPC context containing user information
 * @param profileId - The ID of the profile to verify ownership of
...
function verifyProfileOwnership(
  ...
  // Verify the current user owns the profile
