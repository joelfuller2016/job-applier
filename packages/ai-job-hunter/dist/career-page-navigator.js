...
export class CareerPageNavigator {
     ...
     */
    async navigateToApplication(page, job) {
        let steps = 0;
        try {
            // Start at job URL
     ...
     */
    async clickApplyButton(page, analysis) {
     ...
     */
    async clickOnJob(page, jobTitle, analysis) {
     ...
     */
    async tryFindApplicationPath(page) {
        const paths = [
            'a:has-text("Apply")',
            'a:has-text("Careers")',
            'a:has-text("Jobs")',
     ...
     */
    async navigateMultiPageForm(page, onPageComplete) {
        let pageCount = 0;
     ...
     */
    async captureScreenshot(page, _name) {
...
//# sourceMappingURL=career-page-navigator.js.map